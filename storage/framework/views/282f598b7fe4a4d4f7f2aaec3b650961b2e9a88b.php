...
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo e(Gravatar::src(Auth::user()->email)); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo e(Auth::user()->username); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo e(Gravatar::src(Auth::user()->email)); ?>" class="img-circle" alt="User Image">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(url('admin/users')); ?>"><i class="fa fa-circle-o"></i>Users</a></li>
          </ul>
        </li>
       <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo e(url('admin/permissions')); ?>"><i class="fa fa-circle-o"></i> Permissions</a></li>
          </ul>
        </li>
        <li>
          <a href="<?php echo e(url('admin/sliders')); ?>">
            <i class="fa fa-map-o"></i> <span>Slider</span>
          </a>
        </li>
        <li>
          <a href="<?php echo e(url('admin/blogs')); ?>">
            <i class="fa fa-wpforms"></i> <span>Blog</span>
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="<?php echo e(url('admin/videos')); ?>">
            <i class="fa fa-youtube-play"></i> <span>Video's</span>
          </a>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(url('admin/tags/blog')); ?>"><i class="fa fa-circle-o"></i>Blogs</a></li>
            <li><a href="<?php echo e(url('admin/tags/forum')); ?>"><i class="fa fa-circle-o"></i>Forum</a></li>
          </ul>
        </li>
        <li>
          <a href="#">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(url('admin/slidertrash')); ?>"><i class="fa fa-circle-o"></i>Slider</a></li>
            <li><a href="<?php echo e(url('admin/blogtrash')); ?>"><i class="fa fa-circle-o"></i>Blogs</a></li>
            <li><a href="<?php echo e(url('admin/portfoliotrash')); ?>"><i class="fa fa-circle-o"></i>Portfolios</a></li>
            <li><a href="<?php echo e(url('admin/videotrash')); ?>"><i class="fa fa-circle-o"></i>Videos</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="https://www.majestic-x.com">Majestic-x </a>.</strong> All rights
    reserved.
  </footer>

            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
               ...
               @forelse($blogs as $blog)
                <tr>
                  <td>{{ $blog->title }}</td>
                  <td> {!! Markdown::parse(str_limit($blog->content, 100))!!}
                  </td>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          {!! Form::open(['method' => 'POST', 'route' => ['admin.blog.restore', $blog->slug] ]) !!}
                   ...
                   <div class="modal modal-danger fade" id="modal-danger">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <button type="button" class="btn btn-outline pull-right" data-dismiss="modal">Cancle</button>
                          {!! Form::open(['method' => 'DELETE', 'route' => ['admin.blog.permadelete', $blog->slug] ]) !!}
